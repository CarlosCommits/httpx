...
type RuntimeTechnologyDetectionMetrics struct {
	...
	JSPropertyPathCount            int              `json:"js_property_path_count,omitempty"`
	JSValueCount                   int              `json:"js_value_count,omitempty"`
	DOMSelectorCount               int              `json:"dom_selector_count,omitempty"`
	DOMValueCount                  int              `json:"dom_value_count,omitempty"`
	CookieCount                    int              `json:"cookie_count,omitempty"`
	ScriptBodiesCaptured           int              `json:"script_bodies_captured,omitempty"`
	ScriptBodiesFetched            int              `json:"script_bodies_fetched,omitempty"`
	ScriptBodyBytes                int              `json:"script_body_bytes,omitempty"`
	CSSBodiesCaptured              int              `json:"css_bodies_captured,omitempty"`
	CSSBodyBytes                   int              `json:"css_body_bytes,omitempty"`
	AppFingerprintCount            int              `json:"app_fingerprint_count,omitempty"`
	RuleEvaluationCount            int              `json:"rule_evaluation_count,omitempty"`
	MatchedTechnologyCount         int              `json:"matched_technology_count,omitempty"`
}
...
type Result struct {
	...
	HeadlessTitle      string                             `json:"headless_title,omitempty" csv:"headless_title" md:"headless_title" mapstructure:"headless_title"`
